    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                <img class="profile" src="assets/images/profile-photo.jpg" alt="" style="width: 100px; height: 100px; border-radius: 50%"/>
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    ...
                    <li class="website"><i class="fa fa-globe"></i><a href="https://vk.com/darkvova" target="_blank"><?= $aboutData['site']?></a></li>
                    <li class="github"><i class="fa fa-github"></i><a href="https://github.com/Vladimirx16" target="_blank"><?= $aboutData['github']?></a></li>
                </ul>
        ...
        <div class="main-wrapper">
            ...
            <section class="section projects-section">
                ...
                <div class="item">
                    <span class="project-title"><?= $projects['name'] ?></span> - <span class="project-tagline"><?= $projects['description'] ?></span>
